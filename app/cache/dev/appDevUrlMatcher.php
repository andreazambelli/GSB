...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if ($pathinfo === '/listefrais') {
            return array (  '_controller' => 'Pg\\GsbFraisBundle\\Controller\\ListeFraisController::indexAction',  '_route' => 'pg_gsb_listefrais',);
        }

        // pg_gsb_saisirfrais
        if ($pathinfo === '/saisirfrais') {
            return array (  '_controller' => 'Pg\\GsbFraisBundle\\Controller\\SaisirFraisController::indexAction',  '_route' => 'pg_gsb_saisirfrais',);
        }

        // pg_gsb_validerfraishorsforfait
        if ($pathinfo === '/validerfraishorsforfait') {
            return array (  '_controller' => 'Pg\\GsbFraisBundle\\Controller\\SaisirFraisController::validerfraishorsforfaitAction',  '_route' => 'pg_gsb_validerfraishorsforfait',);
        }

        // pg_gsb_supprimerfraishorsforfait
        if (0 === strpos($pathinfo, '/supprimerfraishorsforfait') && preg_match('#^/supprimerfraishorsforfait/(?P<id>[^/]++)$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'pg_gsb_supprimerfraishorsforfait')), array (  '_controller' => 'Pg\\GsbFraisBundle\\Controller\\SaisirFraisController::supprimerfraishorsforfaitAction',));
        }
